'use strict';(function(){const searchDataURL='/en.search-data.min.096dc638d12ed2daf07e6460ed0f7bf99857c3cc8e0e46d128017357949c80e6.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
