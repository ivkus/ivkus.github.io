'use strict';(function(){const searchDataURL='/en.search-data.min.cfcd033ef461cd6bb9e8f3af667b959819b27207d1ba0c277ba0922fd4210b74.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
